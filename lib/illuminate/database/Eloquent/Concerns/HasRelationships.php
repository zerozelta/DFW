...
trait HasRelationships
{
    ...
    public function morphTo($name = null, $type = null, $id = null, $ownerKey = null)
    {
        ...
        // use that to get both the classes and foreign key that will be utilized.
    ...
    /**
     * Retrieve the actual classes name for a given morph classes.
     *
     * @param  string  $class
     * @return string
     */
    ...
    /**
     * Get the classes name for polymorphic relations.
     *
     * @return string
     */
